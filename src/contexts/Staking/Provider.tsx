...
export const StakingProvider = (props: Props) => {
  ...
  const getCombos = useCallback(
    (animal: Animal) => {
      ...
      const back_accessory: string | undefined = attributes.find(
        (x: any) =>
          x.trait_type.toLowerCase() === "Body accessories (Back)".toLowerCase()
      )?.value;
      const skin: string | undefined = attributes.find(
        (x: any) => x.trait_type.toLowerCase() === "Body".toLowerCase()
      )?.value;
      const clothing: string | undefined = attributes.find(
        (x: any) => x.trait_type.toLowerCase() === "Clothes".toLowerCase()
      )?.value;
      const front_accessory: string | undefined = attributes.find(
        (x: any) =>
          x.trait_type.toLowerCase() ===
          "Body accessories (Front)".toLowerCase()
      )?.value;
      const hair: string | undefined = attributes.find(
        (x: any) => x.trait_type.toLowerCase() === "Hair".toLowerCase()
      )?.value;
      const hair_accessory: string | undefined = attributes.find(
        (x: any) =>
          x.trait_type.toLowerCase() === "Hair accessories".toLowerCase()
      )?.value;
      const mouth_accessory: string | undefined = attributes.find(
        (x: any) =>
          x.trait_type.toLowerCase() === "Mouth accessories".toLowerCase()
      )?.value;
      const eyes: string | undefined = attributes.find(
        (x: any) => x.trait_type.toLowerCase() === "Eyes".toLowerCase()
      )?.value;
      const eyewear: string | undefined = attributes.find(
